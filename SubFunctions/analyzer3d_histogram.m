function varargout = analyzer3d_histogram(varargin)
% This function is part of analyzer3d
%
...
% Edit the above text to modify the response to help analyzer3d_histogram
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @analyzer3d_histogram_OpeningFcn, ...
                   'gui_OutputFcn',  @analyzer3d_histogram_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before analyzer3d_histogram is made visible.
function analyzer3d_histogram_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to analyzer3d_histogram (see VARARGIN)
% Choose default command line output for analyzer3d_histogram
...
function varargout = analyzer3d_histogram_OutputFcn(hObject, eventdata, handles) 
